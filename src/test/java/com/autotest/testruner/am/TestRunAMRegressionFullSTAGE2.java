...
//            , tags = {"~@Ignore,~@Login002"}  // And run Model
        , tags = {"@AM_Regression_DMSpushOnly-STAGE2,@AM_Regression_Others-STAGE2,@AM_Regression13_Recall-STAGE2","~@Ignore","~@Debug"}
)

public class TestRunAMRegressionFullSTAGE2 {
